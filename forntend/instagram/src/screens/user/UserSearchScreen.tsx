...
import { View, TextInput, FlatList, Text, TouchableOpacity, Image, StyleSheet, ActivityIndicator } from 'react-native';
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  input: { margin: 12, borderWidth: 1, borderRadius: 10, padding: 12, fontSize: 16 },
  userRow: { flexDirection: 'row', alignItems: 'center', padding: 10, borderBottomWidth: 1 },
